    ...
    <div className="bg-slate-400 py-20 px-10 grid gap-10 min-h-screen">
      <div className="bg-white p-6 rounded-3xl shadow-xl">
        ...
        <ul>
          {["1", "2", "3", "4", ""].map((i) => (
            <div
              key={i}
              className="flex justify-between my-2 first:bg-blue-50 last:bg-blue-50 only:bg-red-300 odd:bg-green-200 empty:hidden"
            >
              <span className="text-gray-500">Gray Chair</span>
              <span className="font-semibold">$19{i}</span>
            </div>
          ))}
        </ul>
      ...
      <div className="bg-white p-6 rounded-2xl shadow-xl">
        ...
        <div className="flex flex-col">
          <span className="font-medium text-xl">Swon Lounge</span>
